// lib/msgraph.js
// KV_FREE: no '@vercel/kv' anywhere in this file.
// Minimal MS Graph helpers + compatibility exports. Uses your own logic only.
...
export async function searchPagesInSection() {
  throw new Error("searchPagesInSection disabled. Use known IDs.");
}
