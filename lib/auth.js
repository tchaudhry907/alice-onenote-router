...
// and requireAuth (legacy/session check so older routes keep building)
...
// Kept so older routes that import { requireAuth } don't break the build.
// (If you want, we can later wire this to your ACTION_BEARER_TOKEN.)
