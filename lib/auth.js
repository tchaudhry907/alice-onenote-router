// /lib/auth.js
// Minimal helpers for API routes to obtain/require a valid Graph access token.
...
// Named export used by routes that just need a token (may refresh)
export async function getAccessToken(req, res) {
  // Allow server-to-server via Bearer
...
// Back-compat helper: used by /api/cron/bind and others
