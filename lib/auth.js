...
// and requireAuth (legacy/session check) so all imports work.

//
// 1. For Graph client credentials flow
//
...
//
// 2. For backwards compatibility (used in other API routes)
//
export function requireAuth(req, res) {
  // If your old routes relied on session cookies, keep them here.
  // For now, we’ll just stub a 401 until you decide if you need it.
