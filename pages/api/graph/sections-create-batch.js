...
// Idempotently ensure sections exist inside a notebook.
// Auth: Authorization header OR access_token cookie.
...
async function readBody(req) {
  // Next.js (pages/api) usually populates req.body, but be robust:
