...
// This version does NOT import @vercel/kv. It just classifies and returns payload
// (your cron drain / other routes can consume the payload).
...
export default async function handler(req, res) {
  ...
  // Return the structured payload; your cron drain will post/append later.
